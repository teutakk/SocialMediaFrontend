...
const Chat = () => {
  ...
  const checkOnlineStatus = (chat) => {
    const chatMember = chat.members && chat.members.find((member) => member !== user._id);
    const online = onlineUsers && onlineUsers.find((user) => user.userId === chatMember);
    ...
    <div className={classes.Chat}>
      ...
      <div className={classes["left-side-chat"]}>
        <div className={classes["chat-container"]}>
          <h3 style={{fontFamily: "Montserrat, sans-serif", fontWeight: "500", fontSize: "22px"}}>Messages</h3>
